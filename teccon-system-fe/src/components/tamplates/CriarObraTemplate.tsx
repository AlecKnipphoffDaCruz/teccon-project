...
import CriarObraOrganism from "../organisms/CriarObraOrganism";
import GerenciarObrasOrganism from "../organisms/GerenciarObrasOrganism";
                ...
                <main className="flex-1 ml-[72px] px-6 py-8 overflow-y-auto">
                    ...
                    <div className="mb-7 fade-up">
                        <div className="flex items-center gap-2 text-sm text-gray-400 mb-2">
                            ...
                            <span className="text-[#1A5FAD] font-semibold"> Obras</span>
                        </div>
                    ...
                    <div className="flex flex-col items-center">
                        ...
                        <div key={tab} className="fade-up w-full flex justify-center">
                            {tab === "criar" && <CriarObraOrganism onSuccess={() => setTab("gerenciar")} />}
                            {tab === "gerenciar" && <GerenciarObrasOrganism />}
                        </div>
